...
mindmaps.ApplicationController = function() {
  ...
  var filePickerController = new mindmaps.FilePickerController(eventBus, mindmapModel);
  ...
  function doSaveDocument() {
    var presenter = new mindmaps.SaveDocumentPresenter(eventBus,
        mindmapModel, new mindmaps.SaveDocumentView(), autosaveController, filePickerController);
    presenter.go();
  }
  ...
  function doOpenDocument() {
    var presenter = new mindmaps.OpenDocumentPresenter(eventBus,
        mindmapModel, new mindmaps.OpenDocumentView(), filePickerController);
    presenter.go();
  }
